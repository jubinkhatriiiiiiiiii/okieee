...
import {providerInitializationService} from './lib/services/ProviderInitializationService';
...
const App = () => {
  ...
  // Initialize update service and provider system
  useEffect(() => {
    // Start automatic update checking at app startup
    updateProvidersService.startAutomaticUpdateCheck();

    // Initialize all providers automatically
    providerInitializationService.initializeAllProviders()
      .catch(error => {
